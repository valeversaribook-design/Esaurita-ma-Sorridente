/* =====================================================
   ...
   =====================================================
   Modifica QUI il link alla recensione Amazon del libro.

   Per ottenere il link corretto:
   1. Vai alla pagina del libro su Amazon.it
   2. Copia l'ASIN (es. B0XXXXXXXX) dall'URL
   3. Sostituiscilo qui sotto
   ===================================================== */
...
window.BONUS_CONFIG = {
  ...
  bookSubtitle: "130 giorni per le donne che tengono tutto insieme tranne se stesse"
};
